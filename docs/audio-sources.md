...
This file records provenance for release packaging. It is not an in-game credits
screen; none of the current sources require attribution.

## Sound effects

- Source: [FilmCow SFX](https://filmcow.itch.io/filmcow-sfx)
